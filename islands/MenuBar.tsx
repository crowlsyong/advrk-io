    ...
    <nav class="bg-white border-b border-gray-300 shadow-sm">
        ...
        <div class="relative flex items-center justify-between h-16">
          ...
          <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            <div class="hidden sm:block sm:ml-6">
              ...
              <a
                  href="/"
                  class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-white hover:bg-gray-700"
                >
      ...
      {isOpen && (
        <div class="sm:hidden">
          ...
          <a
              href="/"
              class="flex items-center px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-white hover:bg-gray-700"
            >
              <IconHome class="h-6 w-6 mr-1" />
              Home
            </a>
